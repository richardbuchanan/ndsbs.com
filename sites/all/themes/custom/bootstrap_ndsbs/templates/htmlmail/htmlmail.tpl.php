...
$headers['From'] = variable_get('site_name', 'New Directions Substance and Behavioral Services') . ' <' . $default_from . '>';

if ($from && $from != $default_from) {
  $headers['From'] = variable_get('site_name', 'New Directions Substance and Behavioral Services') . ' <info@ndsbs.com>';;
}
