 ...
 */
  ...
  $overrides = 'https://www.ndsbs.com/sites/ndsbs.com/themes/contrib/uikit/css/overrides.css';
  $ndsbs_icons = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.icons.css';
  $ndsbs_uikit_components = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.uikit.components.css';
  $ndsbs_base = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.base.css';
  $ndsbs_layout = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.layout.css';
  $ndsbs_component = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.component.css';
  $ndsbs_theme = 'https://www.ndsbs.com/sites/ndsbs.com/themes/custom/ndsbs/css/ndsbs.theme.css';

  $ndsbs_address = '<div class="uk-section uk-section-default uk-section-small uk-text-center">';
  $ndsbs_address .= '<p><span class="uk-display-inline-block uk-margin-small-bottom"><strong>New Directions Substance<br>and Behavioral Services</strong></span>';
  $ndsbs_address .= '<br>6797 N. High St. Ste. 350';
  $ndsbs_address .= '<br>Worthington, OH 43085</p>';
  $ndsbs_address .= '<p><a href="mailto:info@ndsbs.com">info@ndsbs.com</a>';
  $ndsbs_address .= '<br>1-800-671-8589';
  $ndsbs_address .= '</div>';
?>
<style type="text/css" media="all">
  @import url("https://cdnjs.cloudflare.com/ajax/libs/uikit/3.0.0-beta.35/css/uikit.min.css");
  @import url(<?php print $overrides; ?>);
  @import url(<?php print $ndsbs_icons; ?>);
  @import url(<?php print $ndsbs_uikit_components; ?>);
  @import url(<?php print $ndsbs_base; ?>);
  @import url(<?php print $ndsbs_layout; ?>);
  @import url(<?php print $ndsbs_component; ?>);
  @import url(<?php print $ndsbs_theme; ?>);
</style>
<div class="htmlmail-body"><header id="page-header--maintenance"><nav id="page-navbar" class="uk-navbar-container uk-navbar" style="height:80px;"><div class="uk-navbar-center"><a href="https://www.ndsbs.com" id="site-logo" class="uk-navbar-item uk-logo" title="Home" rel="home"><img class="uk-margin-small-right" src="https://www.ndsbs.com/sites/dev.ndsbs.com/themes/custom/ndsbs/logo-extended.png" alt="Home" style="max-height:60px!important;"></a></div></nav></header><div id="page" class="uk-container uk-margin"><div class="uk-grid uk-grid-stack"><div id="page-content" class="uk-width-1-1 uk-first-column"><?php echo $body; ?><?php echo $ndsbs_address; ?></div></div></div></div>
<?php if ($debug):
