...
/**
 * Autotab Registration Form
 */
jQuery('#edit-field-area-code-primary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-prefix-primary-und-0-value',
  maxlength: 3
});
jQuery('#edit-field-prefix-primary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-line-number-primary-und-0-value',
  maxlength: 3
});
jQuery('#edit-field-line-number-primary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-area-code-secondary-und-0-value',
  maxlength: 4
});
jQuery('#edit-field-area-code-secondary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-prefix-secondary-und-0-value',
  maxlength: 3
});
jQuery('#edit-field-prefix-secondary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-line-number-secondary-und-0-value',
  maxlength: 3
});
jQuery('#edit-field-line-number-secondary-und-0-value').autotab({
  format: 'numeric',
  target: '#edit-field-name-und-0-given',
  maxlength: 4
});
jQuery('#edit-field-address-und-0-postal-code').autotab({
  format: 'numeric',
  target: '#edit-field-referral-und',
  maxlength: 5
});
jQuery('#edit-field-recipient-information-und-0-postal-code').autotab({
  format: 'numeric',
  target: '#edit-mail',
  maxlength: 5
});
