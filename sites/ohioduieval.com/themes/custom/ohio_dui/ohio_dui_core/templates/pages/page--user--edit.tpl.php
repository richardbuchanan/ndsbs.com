        ...
        <div class="content-wrap">
          <div class="settings-nav menu-container">
            <ul class="profile-menu">
              <li class="section">
                <span class="section-head"><?php print $fullname; ?><br />
                  <span>Therapist: <?php print $therapist; ?></span>
                </span>
                <ul class="profile-menu-expanded">
                  <li>
                    <a class="profile selected">Profile</a>
                  </li>
                  <li>
                    <a class="account-settings">Account settings</a>
                  </li>
                  <li>
                    <a class="rush-service">Rush Service</a>
                  </li>
                </ul>
              </li>
            </ul>
...
<script>
(function ($) {
  $('.profile-menu-expanded a').click(function () {
    $('.profile-menu-expanded a').not(this).removeClass('selected');
    $(this).addClass('selected');

    if ($(this).hasClass('profile')) {
      $('#user-user-form-group-profile').show();
      $('#user-user-form-group-account-settings').hide();
      $('#user-user-form-group-rush-service').hide();
    }

    if ($(this).hasClass('account-settings')) {
      $('#user-user-form-group-profile').hide();
      $('#user-user-form-group-account-settings').show();
      $('#user-user-form-group-rush-service').hide();
    }

    if ($(this).hasClass('rush-service')) {
      $('#user-user-form-group-profile').hide();
      $('#user-user-form-group-account-settings').hide();
      $('#user-user-form-group-rush-service').show();
    }
  });
}(jQuery));
</script>
