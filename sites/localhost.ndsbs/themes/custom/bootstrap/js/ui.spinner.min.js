 ...
 */
(function (j) {
  var s = "ui-state-active", l = j.ui.keyCode, C = l.UP, D = l.DOWN, t = l.RIGHT, E = l.LEFT, u = l.PAGE_UP, v = l.PAGE_DOWN, J = l.HOME, K = l.END, N = [C, D, t, E, u, v, J, K, l.BACKSPACE, l.DELETE, l.TAB], O;
  j.widget("ui.spinner", {
    options: {
      min: null,
      max: null,
      ...
      function d(e) {
        for (var h = 0; h < N.length; h++)if (N[h] == e)return true;
        return false
      }
      ...
      var c = this, f = c.options, r = f.className, y = f.width, n = f.showOn, H = j.support.boxModel, Q = a.outerHeight(), R = c.oMargin = b(a.css("margin-right")), I = c.wrapper = a.css({
      ...
      if (!p && (f = b.attr("step")) != null)if (f != "any") {
        p = parseFloat(f);
        d.largeStep *= p
      }
