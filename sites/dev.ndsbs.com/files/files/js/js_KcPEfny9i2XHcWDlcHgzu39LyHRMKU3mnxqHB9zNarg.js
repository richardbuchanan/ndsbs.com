...
Drupal.ajax.prototype.beforeSend = function (xmlhttprequest, options) {
  ...
  else if (this.progress.type == 'modal') {
      this.progress.element = $('<div id="payment-reload"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span></div>');
      if (this.progress.message) {
        $('.throbber', this.progress.element).after('<div class="message">' + this.progress.message + '</div>');
      }
      $(this.wrapper).after(this.progress.element);
      $('body').addClass('payment-reloading');
    }
};
...
Drupal.ajax.prototype.success = function (response, status) {
  ...
  if (this.progress.element) {
    ...
    $('body').removeClass('payment-reloading');
  }
...
Drupal.ajax.prototype.commands = {
  ...
  insert: function (ajax, response, status) {
    ...
    // NOTE: Ignore the extra div if using the payment form.
    if ($('#payment-ajax-load').length) {
