...
?>
<!-- Begin client_allrequest_list.tpl.php -->
<h1>All Requests</h1>
        ...
        <?php case 'counseling_request': ?>
          ...
          <tr>
            ...
            <td>
              ...
              <br />
              <b>No. of Sessions - </b><?php print $rec->field_no_of_sessions_required['und'][0]['value']; ?>
              <br />
              <b>Availability  required - </b><?php print $rec->field_availability_required['und'][0]['value']; ?>
              <br />
              <b>Comments - </b><?php print $rec->field_counselingrequest_comment['und'][0]['value']; ?>
            </td>
            <td><?php print date('M d Y h:i A', $rec->created); ?></td>
            <td><?php print $attempted_on; ?></td>
          </tr>
    ...
    <?php foreach($trans_data as $transdata): ?>
      ...
      <tr>
        ...
        <td>
          ...
          <br />
          <b>Transaction Date - </b><?php print date('M d, Y', $transdata->order_date); ?>
        </td>
...
<!-- End client_allrequest_list.tpl.php -->
