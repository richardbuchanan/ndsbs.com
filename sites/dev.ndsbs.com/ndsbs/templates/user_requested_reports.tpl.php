...
<!--<p class="mt_20"><b>MR</b>: Main Report, <b>SR</b>: Sub Report, <b>EM</b>: Express Mail, <b>NR</b>: Notary Request</p>-->
...
//        echo '</pre>';
            ...
            <tr>
                ...
                <td>
                    ...
                    if ($sub_info->main_report <> '') {
                        ...
                        print l(t('Download Doc'), $base_url . '/download/report', array('query' => array('file_name_path' => $file_name_path), 'attributes' => array('class' => 'download_icon')));

                        //  Send report in email
                        print l(t('Email Doc'), $base_url . '/send/attachment', array('query' => array(
                                'file_name_path' => $file_name_path, 'file_name' => $fname,
        ...
        if ($record_not_found == 0) {
            ?>
            <tr><td class="txt_ac" colspan="4">No record found.</td></tr>
            <?php
        }
        ?>
    </table>
