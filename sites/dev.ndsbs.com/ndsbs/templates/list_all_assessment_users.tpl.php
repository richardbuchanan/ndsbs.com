...
?>
<h1> All Assessments Users</h1>
<div  class="field_fixed full_width left">
  <?php print search_assessment_client(); ?>
</div>
<div class="table_wrap">
  <table class="schedule_table list-all-assessment-users">
    <tr class="bkg_b">
      <th class="all-assessment-clients">Client</th>
      <th class="all-assessment-service">Service & Status</th>
      <th class="all-assessment-questionnaire">Questionnaire</th>
      <th class="all-assessment-duration">Service Duration</th>
      <th class="all-assessment-counselor">Assign Counselor</th>
      <th class="all-assessment-actions">Action</th>
    </tr>
    <?php
          ...
          <td>
            ...
            <?php if($total_attempted > 0): ?>
              ...
              <div class="form-actions">
                <?php print l(t('View'), $base_url.'/admin/questionnaire/'.$data_info->nid.'/trans/'.$data_info->order_id.'/uid/' . $data_info->uid . '/service/' . $main_service, $view_option); ?>
...
<?php print $output = theme('pager', array(
  'quantity' => 3
));
