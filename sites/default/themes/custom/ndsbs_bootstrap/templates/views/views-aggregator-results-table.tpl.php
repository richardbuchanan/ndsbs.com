...
?>
<table class="table table-striped table-responsive sticky-enabled<?php if ($classes): ?> <?php print "$classes table"; ?><?php endif ?>"<?php print $attributes; ?>>
    ...
    <tr <?php if (!empty($totals_row_class)): ?>class="<?php print $totals_row_class; ?>"<?php endif ?>>
      ...
      foreach (array_keys(reset($rows)) as $field):
        ...
        <th <?php if (!empty($fclasses)): ?>class="<?php print $fclasses; ?>"<?php endif ?>>
          <?php print isset($totals[$field]) ? $totals[$field] : 'Total'; ?>
        </th>
      <?php endforeach ?>
    </tr>
    </tfoot>
